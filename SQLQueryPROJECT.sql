...
(1, 'S', N'Xanh nhạt', 'available', N'Mới 95%'),
(1, 'M', N'Xanh nhạt', 'rented', N'Mới 90%'),
(2, 'L', N'Đen lục bảo', 'available', N'Mới 98%'),
(2, 'XL', N'Đen lục bảo', 'maintenance', N'Sứt chỉ nhẹ'),
(3, 'M', N'Trắng đỏ', 'rented', N'Mới 85%'),
(4, 'S', N'Tím dạ hội', 'available', N'Mới 100%'),
(5, 'M', N'Xanh caro', 'available', N'Mới 92%'),
(6, 'L', N'Xanh lá đậm', 'rented', N'Mới 99%'),
(7, 'M', N'Đỏ quần xanh', 'available', N'Mới 90%'),
(7, 'L', N'Đỏ quần xanh', 'available', N'Mới 88%');
...
(1, 2, N'Mới 90%', N'Mới 90% ổn định', 150000.00), -- Đơn 1 thuê món 2
(2, 5, N'Mới 85%', NULL, 200000.00),             -- Đơn 2 thuê món 5
(3, 2, N'Mới 92%', N'Mới 90%', 150000.00),         -- Đơn 3 thuê món 2 (đã trả)
(3, 1, N'Mới 95%', N'Mới 95%', 150000.00),         -- Đơn 3 thuê thêm món 1
(4, 6, N'Mới 100%', NULL, 180000.00),            -- Đơn 4 thuê món 6
(6, 8, N'Mới 99%', NULL, 220000.00);             -- Đơn 6 thuê món 8
